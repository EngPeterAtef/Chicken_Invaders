...
// FreeCameraControllerComponent. This system is added as a slightly complex example for how use the ECS framework to
// implement logic. For more information, see "common/components/free-camera-controller.hpp"
class FreeCameraControllerSystem
{
  ...
  public:
    ...
    void update(World *world, float deltaTime)
    {
        ...
        // If there is no entity with both a CameraComponent and a FreeCameraControllerComponent, we can do nothing so
        // we return
        if (!(camera && controller))
            return;
